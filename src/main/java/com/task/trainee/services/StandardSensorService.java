 ...
 *
 * This class processes user requests about sensors in the {@link SensorsRepository}
 */
@Service
public class StandardSensorService extends SensorService {
    ...
    public StandardSensorService(@Autowired SensorsRepository repository,
    ...
    public String getSensors(List<Predicate<Sensor>> filters) {
